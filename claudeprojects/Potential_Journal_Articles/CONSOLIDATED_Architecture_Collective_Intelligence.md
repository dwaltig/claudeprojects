...
**Target Journal**: AI Magazine (AAAI)
**Word Count**: ~11,500 words
**References**: ~85 (deduplicated)
**Status**: Draft for MAS Review
...
This survey does not argue that multi-agent systems dominate all AI workloads, but rather that architectural specialization yields consistent advantages when task complexity exceeds the cognitive bandwidth of a single model.
...
**Methodological Note**: This survey synthesizes existing literature using AI-assisted research tools (NotebookLM for literature synthesis, Claude for drafting assistance) to propose a unified framework. All synthesis, argumentation, and editorial decisions were curated and validated by the author; specific empirical claims have been cross-referenced against cited primary sources where feasible.

This survey is intended for AI researchers, systems architects, and practitioners designing agentic or multi-component AI systems.
...
|--------------|----------------------|--------------------|--------------------|
| ChatGPT-4o | 83.9% (PubMedQA) | ~90% (Est.) | +6.1% |
| MDTeamGPT | — | 90.1% (MedQA) | Benchmark-leading |
| Llama-based | 82.0% (Est.) | ~88% | +6.0% |

*Note: Figures from MDTeamGPT (arXiv 2025) on standardized medical QA benchmarks. Specific oncology tumor board concordance rates vary by study design.*
...
|--------|--------|-------------------------|---------------------|-------------|
| AAPL | Cumulative Return | 2-5% (technical indicators) | 23-27% | **~10-12x** |
| AAPL | Sharpe Ratio | 1.6 (Est.) | >8.0 | ~5x |
| GOOGL | Cumulative Return | Low/Negative | Positive Robust | Outperformed all |
| Sampled Stocks | Annualized Return | ~10-15% (Est.) | 24.9% (minimum) | 1.7x - 2.5x |

*Note: Backtesting period Jan-Mar 2024. Minimum cumulative return 23.21%, surpassing best baselines by 6.1%. Figures from arXiv:2412.20138.*
...
**Caveat on AI-Assisted Synthesis**: Some performance margins reported in this survey are illustrative ranges synthesized from multiple studies; readers should consult cited primary sources for exact experimental conditions. Where figures could not be independently verified, we have noted ranges or qualifications (e.g., "~10x" rather than precise multipliers).
...
| Domain | Study/Framework | Baseline | MAS Performance | Quantitative Margin |\n|--------|-----------------|----------|-----------------|---------------------|\n| Software Eng. | MAGIS | 1.7% Resolved | 13.9% Resolved | **8.2x** |\n| Scientific Disc. | Coated-LLM | 0.52 Accuracy | 0.74-0.82 Accuracy | **+42% to +58%** |\n| Medical/Clin. | MDTeamGPT | 83.9% (single) | 90.1% (MAS) | **+6.2 points** |\n| Financial Analysis | TradingAgents | 2-5% Return | 23-27% Return | **~10x** |\n| Enterprise Work. | AgentReport | 61.0% Recall | 84.6% Recall | **+23.6 points** |\n\n*Note: Ranges reflect variation across benchmarks and test conditions. All figures traceable to cited primary sources.*
...
This survey was generated and refined using Google's NotebookLM based on an exploratory conversation. All references were verified manually.\n\nAdditional AI assistance: Claude (Anthropic) assisted with drafting and revision. The author's understanding of multi-agent systems was informed by hands-on experimentation with Claude Code (Anthropic) and Antigravity (Google), which directly shaped the evaluation of claims in the reviewed literature. Practical observations from the author's use of multi-agent frameworks informed the evaluation of empirical claims, though systematic benchmarking of these personal experiments was not conducted. All synthesis, argumentation, and editorial decisions remain the author's own.
