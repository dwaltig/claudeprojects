#!/usr/bin/env python3
"""
Convert Heart Sutra Reborn to DOCX format for ElevenReader
"""
...
def create_docx():
    ...
    with open('Heart_Sutra_Blues.md', 'r', encoding='utf-8') as f:
        content = f.read()
    ...
    for line in lines:
        ...
        # Detect markdown H4 headers (#### Title)
        if line.startswith('#### '):
            title_text = line[5:]
        ...
        # Performance notes in parentheses - render as italic
    ...
    # Save
    output_file = 'The_Heart_Sutra_Reborn_ELEVENREADER.docx'
    doc.save(output_file)
    print(f"Created: {output_file}")
    print("Headers: Detected from markdown syntax")
    print("Ready for ElevenReader submission")
