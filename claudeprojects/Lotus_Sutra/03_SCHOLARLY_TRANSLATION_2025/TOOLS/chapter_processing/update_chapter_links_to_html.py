...
def update_chapter_file(chapter_num):
    ...
    if chapter_num in CHAPTERS_WITH_GUIDES:
        ...
        replacement = f'''<h3>Deepen Your Study</h3>
                <p>
                    <strong><a href="../_PRACTICE_LAYER/02_Chapter_Study_Guides/html/chapter_{chapter_num:02d}.html" target="_blank">📖 Complete Study Guide</a></strong>
                </p>
                <p style="color: #666; font-size: 0.9em; margin-top: 1rem;">
                    Comprehensive interactive guide with learning objectives, key passages, reflection questions, practices,
                    meditation, and discussion questions - beautifully formatted for your device.
                </p>
...
print(f"📁 All study guides now link to formatted HTML pages!")
